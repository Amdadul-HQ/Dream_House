    ...
    return (
        <header className="max-w-screen-xl mx-auto md:mb-0 mb-14 overflow-x-hidden">
            <nav className="flex items-center justify-between py-5 md:px-0 px-5">
                ...
                <ul className={`flex z-50 md:bg-transparent md:p-0 p-4 md:rounded-none rounded-lg bg-white md:static fixed top-16 ${showMenu ? "left-7" : "-left-96"} transition-all duration-500 fixed items-center gap-x-1 md:gap-x-8 text-lg font-medium`}>
