        ...
        albums.map( item => <SwiperSlide key={item.id} item={item} >
            <div className='w-full h-full rounded-2xl bg-no-repeat flex flex-col justify-center items-center' style={{
                ...
                backgroundPosition:'center'
                    ...
                    <h1 className='text-white font-bold text-2xl md:px-0 px-5 md:text-5xl'>{item.estate_title}</h1>
                    <p className='md:w-[900px] text-gray-300 text-base font-light mt-5'>{item.description}</p>
